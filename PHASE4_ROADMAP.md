...
| P4-F2 | Per-segment physiological state: `ChemicalEconomy`-shaped pools attached per relevant `DevelopmentalGraph` node instead of only the head | 2 | F1 | High | Yes (organism ECS footprint grows substantially — see §7 risk) |
